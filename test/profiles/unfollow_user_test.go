...
func TestGivenValidRequestWhenUnfollowUserShouldReturnProfile(t *testing.T) {
	...
	profile, err = followerClient.Profiles.UnfollowUser(context.Background(), followeeUsername)
	if err != nil {
		t.Fatal(err)
	}
